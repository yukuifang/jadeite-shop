...
Page({
  ...
  data: {
    ...
    question_title:["平台的翡翠是天然A货吗？","付款后，怎么保障资金安全？","付款后多久才能发货？","使用什么快递发货？","收到货后不满意怎么退货？","使用购翠平台过程中遇到问题怎么办？"],
  ...
  previewImage:function(event){
    wx.previewImage({
      current: this.data.goodsData.goodsPhotos[event.currentTarget.dataset.index], // 当前显示图片的http链接
